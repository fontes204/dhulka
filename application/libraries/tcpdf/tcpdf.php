...
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	...
	*/
    ...
    //Meu footer
    public function meuFooter(){
        $this->InFooter = true;
        $this->SetFont('times', 'I', 8);
        $this->SetY(-15);
        $this->Cell(0, 6, 'Dhulka - Sistema de Gestão de Terras - '.date('Y'), 0, 0, 'R', FALSE);
//        $this->Cell(0, 6, 'Sistema Integrado de Apoio a Unidade - '.date('Y').' '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, 0, 'R', FALSE);
        $this->InFooter = false;
    }
} // END OF TCPDF CLASS
