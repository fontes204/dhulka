            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li class="text-capitalize">
                        <span>Adicionar Privilégio</span>
                    </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
                            ...
                            <div class="tab-content">
                                <div class="">
                                    <div class="alert alert-info">
                                        <h4 class="form-section">Adicionar privilégios ao grupo <span class="text-primary text-capitalize">"{nome_grupo}"</span></h4>
                                   </div>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="mt-element-ribbon bg-grey-steel">
                                                                            <div class="ribbon ribbon-clip ribbon-shadow ribbon-round ribbon-border-dash-hor ribbon-color-info uppercase">
                                                                                <div class="ribbon-sub ribbon-clip"></div> <?= $menu->nome?>
                                                                            </div>
<!--                                                                            <div class="md-checkbox pull-right">-->
<!--                                                                                <input type="checkbox" id="checkbox--><?//= $menu->id?><!--" id_msm="" class="md-check checkboxes sub-menus">-->
<!--                                                                                <label for="checkbox--><?//= $menu->id?><!--" class="text-capitalize" style="margin-top: 0; text-decoration: underline">-->
<!--                                                                                    <span></span>-->
<!--                                                                                    <span class="check"></span>-->
