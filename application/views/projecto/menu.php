...
<div class="alert alert-info clearfix">
    <ul class="nav nav-pills pull-right">
        <li class="active" disabled="">
            <a class="" id_projecto="<?= $id?>" href="<?= site_url("projecto/coordenar/".$this->session->userdata('id_projecto'))?>"><i class="fa fa-building"></i> Projecto </a>
        </li>
        <li class="active" disabled="">
        ...
        <li class="active">
            <a class="btn-listar-estatistica" href="javascript:;" id_projecto="<?= $id?>"><i class="fa fa-map-o"></i> Google Maps</a>
        </li>
    </ul>
</div>