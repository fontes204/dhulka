            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="profile-sidebar" style="border: 1px solid #e7ecf1">
                        ...
                        <div class="portlet light profile-sidebar-portlet ">
                            ...
                            <a href="#camera_imagem_utente_projecto"  data-toggle="modal" class="btn-ligar-camera-utente_projecto" title="Tirar fotografia">
                                <i class="fa fa-camera m-r-5 fa-2x pull-right"></i>
                            </a>
                            <br>
                        </div>
                        <!-- END PORTLET MAIN -->
                ...
                <div class="col-md-9">
                    <div class="portlet light portlet-fit bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject bold uppercase" style="color: #ff9c00">Modo como fez a inscrição</span>
                            </div>
                        </div>
                            ...
                            <div class="mt-element-step">
                                ...
                                <div class="row step-background-thin">
                                    ...
                                    <div class="col-md-4 bg-grey-steel mt-step-col active">
                                        <a data-toggle="modal" href="#confirmacao_aquisicao_project" style="text-decoration: none">
                                        ...
                                        <input type="hidden" class="id-utente-aq" value="<?= $param?>">
                                    </div>
                                    <div class="col-md-4 bg-grey-steel mt-step-col">
                                        <a href="<?= site_url('processo/aquisicao/presencial/'.$param)?>" style="text-decoration: none">
                    ...
                    <div class="portlet light portlet-fit bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-th-list"  style="color: #ff9c00"></i>
                                <span class="caption-subject bold uppercase" style="color: #ff9c00">Todos Processo</span>
                            </div>
                        </div>
                        <div class="portlet-body">
