                    ...
                    <div class="todo-ui">
                                ...
                                <div class="portlet-body todo-project-list-content">
                                    <div class="todo-project-list">
                                        <ul class="nav nav-stacked text-info ul-desc">
                                            ...
                                            <li class="text-center" style="padding-bottom: 10px; padding-top: 10px; border-bottom: 1px dotted">
                                                <span href="<?= site_url("terreno/novo/".$this->uri->segment(3))?>" class="btn btn-primary btn-add_terreno">Adicionar Terreno</span>
                                            </li>
                                            <li style="padding-bottom: 10px; padding-top: 10px; border-bottom: 1px dotted">
                                                <?php
                        ...
                        <div class="todo-content" style="border: 1px solid #eeeeee">
                            <div class="portlet light ">
                                ...
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span class="caption-subject font-blue  uppercase">&nbsp;</u></span>
                                    </div>
                                </div>
                                <!-- end PROJECT HEAD -->
